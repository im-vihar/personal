    ...
    55622: (e, t, r) => {
      ...
      function g(e) {
        ...
        let r,
          n,
          a,
          [g, P] = (0, u.useOptimistic)(s.IDLE_LINK_STATUS),
          b = (0, u.useRef)(null),
          {
            href: _,
            as: v,
        ...
        A && (n = u.default.Children.only(r));
        let B = A ? n && "object" == typeof n && n.ref : L,
          z = u.default.useCallback(
            (e) => (
              null !== U &&
                (b.current = (0, s.mountLinkInstance)(e, D, U, F, w, P)),
              () => {
                (b.current &&
                  ((0, s.unmountLinkForCurrentNavigation)(b.current),
                  (b.current = null)),
        ...
        return (
          (0, c.isAbsoluteUrl)(K)
            ? (Q.href = K)
            : (A && !j && ("a" !== n.type || "href" in n.props)) ||
              (Q.href = (0, f.addBasePath)(K)),
          (a = A
